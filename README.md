...
1. Explain what a token is used for.
   It is an exchange between the client and server.  It is like a key for the server that allows protected data to be rendered to the client.  

2. What steps can you take in your web apps to keep your data secure?
   That is a  good question, and one that almost seems a bit out of scope of what I'm currently capable of answering.  I've heard about cross-site scripting, DNS attacks, and SQL injections.  At this point - requiring authentication and not saving to local storage would be a good start, but it seems that the business of security is an entire universe of study in itself

3. Describe how web servers work.
   A web server is essentially a computer ( usually a dedicated system ) that serves up files and data.  When you make an http request to a web server, it will answer back with either an error, or hopefully with the resources you requested. 
